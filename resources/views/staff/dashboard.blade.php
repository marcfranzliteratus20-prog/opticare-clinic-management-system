    ...
    <div class="oc-banner mb-4">
        <div class="oc-banner-content">
            <div>
                ...
                <h1 class="oc-title">Welcome, {{ session('user_name') }}</h1>
                <p class="oc-subtitle">
    ...
    <div class="row g-3">
        ...
        <div class="col-6 col-lg-3">
            <div class="oc-card oc-stat" style="--accent: var(--oc-terracotta);">
                <i class="bi bi-receipt oc-stat-icon"></i>
                <span class="oc-stat-label">Unpaid Billing</span>
                <span class="oc-stat-value">{{ $unpaidBilling }}</span>
                <span class="oc-stat-caption">Awaiting payment</span>
            </div>
        </div>
    </div>
</div>
