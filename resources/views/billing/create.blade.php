...
<div class="oc-page">
    ...
    <div class="mb-4">
        ...
        <h2 class="oc-heading">Add Billing</h2>
    </div>
            ...
            <form action="{{ route('billing.store') }}" method="POST">
                ...
                <div class="oc-field">
                    ...
                    <input type="text" name="service_type"
                           placeholder="Example: Eye Checkup / Eyeglasses"
                ...
                <div class="oc-field">
                    ...
                    <input type="number" name="warranty_months" min="0" max="60"
                           placeholder="e.g. 6" value="{{ old('warranty_months') }}">
                </div>
                ...
                <div class="d-flex gap-2 mt-4">
                    <button type="submit" class="oc-btn oc-btn-primary">Save Billing</button>
