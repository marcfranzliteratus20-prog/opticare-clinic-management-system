...
<div class="oc-page">
    ...
    <div class="mb-4">
        ...
        <h2 class="oc-heading">Edit Product</h2>
    </div>
            ...
            <form action="{{ route('inventory.update', $inventory->id) }}" method="POST" enctype="multipart/form-data">
                ...
                @if($inventory->image)
                    <div class="oc-field">
                        ...
                        <img src="{{ asset('storage/' . $inventory->image) }}" alt="{{ $inventory->product_name }}"
                ...
                <div class="oc-field">
                    ...
                    <input type="text" name="category" value="{{ old('category', $inventory->category) }}" required>
                </div>
                ...
                <div class="row g-2">
                    <div class="col-8">
                        <div class="oc-field">
                            ...
                            <input type="number" name="quantity" min="0" value="{{ old('quantity', $inventory->quantity) }}" required>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="oc-field">
                            <label>Unit</label>
                            <select name="unit">
                                @foreach(['pcs', 'pairs', 'boxes', 'bottles', 'sets'] as $u)
                ...
                <div class="oc-field">
                    ...
                    <input type="number" name="reorder_level" min="0" value="{{ old('reorder_level', $inventory->reorder_level) }}">
                </div>
                ...
                <div class="oc-field">
                    <label>Price</label>
                    <input type="number" step="0.01" name="price" min="0" value="{{ old('price', $inventory->price) }}" required>
                </div>

                <div class="oc-field">
                    <label>Replace Image <span class="oc-optional">(optional, max 2MB)</span></label>
                    <input type="file" name="image" accept="image/*">
                </div>

                <div class="d-flex gap-2 mt-4">
                    <button type="submit" class="oc-btn oc-btn-primary">Update Product</button>
