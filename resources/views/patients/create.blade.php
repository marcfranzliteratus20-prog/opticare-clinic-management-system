...
<div class="oc-page">
    ...
    <div class="mb-4">
        ...
        <h2 class="oc-heading">Add New Patient</h2>
    </div>
        ...
        <div class="oc-card-body">
            ...
            <form action="{{ route('patients.store') }}" method="POST">
                ...
                <div class="oc-field">
                    ...
                    <input type="text" name="eye_grade" value="{{ old('eye_grade') }}" placeholder="e.g. OD -1.25 / OS -1.00">
                </div>
                ...
                <div class="d-flex gap-2 mt-4">
                    <button type="submit" class="oc-btn oc-btn-primary">Save Patient</button>
