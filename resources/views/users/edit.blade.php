...
<div class="oc-page">
    ...
    <div class="mb-4">
        ...
        <h2 class="oc-heading">Edit User</h2>
    </div>
    ...
    <div class="oc-card" style="max-width: 560px;">
        <div class="oc-card-body">
            ...
            <form action="{{ route('users.update', $user->id) }}" method="POST">
                ...
                <div class="oc-field">
                    <label>New Password <span class="oc-optional">(leave blank to keep current password)</span></label>
                ...
                <div class="d-flex gap-2 mt-4">
                    <button type="submit" class="oc-btn oc-btn-primary">Update User</button>
